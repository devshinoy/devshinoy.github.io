    ...
    AppComponent.annotations = [
      ...
      new angular.ViewAnnotation({
        template: '<h3>Tasks</h3>' +
                  '<ul  class="collection"><li class="collection-item" *ng-for="#todo of todos"><button class="btn waves-effect waves-light blue accent-4" onclick="removeTodo(this)">X</button>&nbsp;&nbsp;<label><b>{{ todo }}</b></label></li><br/></ul>' +
