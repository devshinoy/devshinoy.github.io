 function AppComponent() {
    ...
    AppComponent.annotations = [
      ...
      new angular.ViewAnnotation({
        template: '<br/><div class="row"><div class="col s12 l4 m4" *ng-for="#note of notes"><div class="card yellow accent-4"><div class="card-content dark-text"><div class ="row"><div class="col s8"><span class="card-title">{{ note }}</span></div><div class="col s4"><button class="btn-floating btn-large waves-effect waves-light orange accent-3" onclick="removeTodo()">X</button></div></div><div class="input-field"><textarea id="textarea1" class="materialize-textarea" placeholder="enter your notes here"></textarea></div></div></div></div></div><br/>' +
