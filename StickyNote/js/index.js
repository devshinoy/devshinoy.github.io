 function AppComponent() {
    ...
    AppComponent.annotations = [
      ...
      new angular.ViewAnnotation({
        template:'<div class="row"><div class="col s12 l4 m4"><br/></div><div class="col s12 l4 m4"><form (submit)="addTodo(notetext)"><input id="input_text" type="text" maxlength="20" placeholder="note title" #notetext><button class="btn waves-effect waves-light orange accent-3" type="submit"><b>+</b></button></form></div></div>' +
